...
const UploadgigExtractor = {
    ...
    /**
     * Resurrect direct download links from uploadgig.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?uploadgig\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?uploadgig\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'uploadgig.com',
                        type: 'file',
                        sourceLayer: 'resurrection_uploadgig_dom',
                        confidence: 0.92
                    });
                }
            }
