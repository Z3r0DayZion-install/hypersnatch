...
const UptoboxExtractor = {
    ...
    /**
     * Resurrect direct download links from uptobox.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?uptobox\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?uptobox\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'uptobox.com',
                        type: 'file',
                        sourceLayer: 'resurrection_uptobox_dom',
                        confidence: 0.92
                    });
                }
            }
