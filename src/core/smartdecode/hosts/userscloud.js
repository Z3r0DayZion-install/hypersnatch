...
const UserscloudExtractor = {
    ...
    /**
     * Resurrect direct download links from userscloud.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?userscloud\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?userscloud\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'userscloud.com',
                        type: 'file',
                        sourceLayer: 'resurrection_userscloud_dom',
                        confidence: 0.92
                    });
                }
            }
