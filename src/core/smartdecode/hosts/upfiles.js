...
const UpfilesExtractor = {
    ...
    /**
     * Resurrect direct download links from upfiles.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?upfiles\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?upfiles\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'upfiles.com',
                        type: 'file',
                        sourceLayer: 'resurrection_upfiles_dom',
                        confidence: 0.92
                    });
                }
            }
