/**
 * SmartDecode 2.0 - Daofile.com Extractor
 */

const DaofileExtractor = {
    PATTERNS: [
        /https?:\/\/(?:www\.)?daofile\.com\/([a-zA-Z0-9]+)/i
    ],
    ...
    /**
     * Resurrect direct download links from daofile.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?daofile\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?daofile\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'daofile.com',
                        type: 'file',
                        sourceLayer: 'resurrection_daofile_dom',
                        confidence: 0.92
                    });
                }
            }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = DaofileExtractor;
}
