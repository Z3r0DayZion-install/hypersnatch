/**
 * SmartDecode 2.0 - Ddownload.com Extractor
 */

const DdownloadExtractor = {
    PATTERNS: [
        /https?:\/\/(?:www\.)?ddownload\.com\/([a-zA-Z0-9]+)/i
    ],
    ...
    /**
     * Resurrect direct download links from ddownload.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?ddownload\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?ddownload\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'ddownload.com',
                        type: 'file',
                        sourceLayer: 'resurrection_ddownload_dom',
                        confidence: 0.92
                    });
                }
            }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = DdownloadExtractor;
}
