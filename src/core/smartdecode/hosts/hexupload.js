...
const HexuploadExtractor = {
    ...
    /**
     * Resurrect direct download links from hexupload.net page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?hexupload\\.net[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?hexupload\\.net[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'hexupload.net',
                        type: 'file',
                        sourceLayer: 'resurrection_hexupload_dom',
                        confidence: 0.92
                    });
                }
            }
