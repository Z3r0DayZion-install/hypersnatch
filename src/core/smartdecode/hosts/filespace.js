/**
 * SmartDecode 2.0 - Filespace.com Extractor
 */

const FilespaceExtractor = {
    PATTERNS: [
        /https?:\/\/(?:www\.)?filespace\.com\/([a-zA-Z0-9]+)/i
    ],
    ...
    /**
     * Resurrect direct download links from filespace.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?filespace\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?filespace\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'filespace.com',
                        type: 'file',
                        sourceLayer: 'resurrection_filespace_dom',
                        confidence: 0.92
                    });
                }
            }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = FilespaceExtractor;
}
