/**
 * SmartDecode 2.0 - Katfile.com Extractor
 */

const KatfileExtractor = {
    PATTERNS: [
        /https?:\/\/(?:www\.)?katfile\.com\/([a-zA-Z0-9]+)/i
    ],
    ...
    /**
     * Resurrect direct download links from katfile.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?katfile\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?katfile\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'katfile.com',
                        type: 'file',
                        sourceLayer: 'resurrection_katfile_dom',
                        confidence: 0.92
                    });
                }
            }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = KatfileExtractor;
}
