...
const FilefactoryExtractor = {
    ...
    /**
     * Resurrect direct download links from filefactory.com page source
     */
    resurrect(html, hostCandidate) {
        ...
        const domPatterns = [
            ...
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?filefactory\\.com[^"']*\/dl\/[^"']+)["'])/gi,
            /(?:href=["'](https?:\/\/(?:[a-z0-9]+\.)?filefactory\\.com[^"']*\/download\/[^"']+)["'])/gi,
            ...
            while ((match = localRegex.exec(html)) !== null) {
                ...
                if (!directCandidates.some(c => c.url === url)) {
                    directCandidates.push({
                        ...
                        host: 'filefactory.com',
                        type: 'file',
                        sourceLayer: 'resurrection_filefactory_dom',
                        confidence: 0.92
                    });
                }
            }
