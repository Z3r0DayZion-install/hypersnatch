  ...
  async replayEvent(event) {
    ...
    switch (type) {
      case this.EventType.INGEST_START:
        // Resume ingest operation
        if (data.queueData) {
          return this.resumeIngest(data.queueData);
        }
        break;
      ...
      case this.EventType.DECODE_START:
        ...
        if (decodeJobData) {
          return this.resumeDecode(data.decodeJobData);
        }
        break;
      ...
      case this.EventType.IMPORT_START:
        ...
        if (importData) {
          return this.resumeImport(data.importData);
        }
        break;
      ...
      case this.EventType.EXPORT_START:
        ...
        if (exportData) {
          return this.resumeExport(data.exportData);
        }
        break;
        
      default:
        throw new Error(`Cannot replay event type: ${type}`);
    }
  },
