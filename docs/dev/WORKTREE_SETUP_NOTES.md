...
Current stable shipped line: `v1.5.5`  
Current hardening line: `release-readiness/v1.5.6-hardening`
...
- Warning inventory process:
  ...
  2. Capture any warnings in `docs/dev/DEPENDENCY_WARNING_INVENTORY_v1.5.5.md`.
