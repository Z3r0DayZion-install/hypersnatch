...
| Governance/status/setup truth alignment to `v1.5.6` | P1 | Completed (slice 3) | Top-level repo surfaces now reflect shipped `v1.5.6` truth, active `v1.5.7-hardening` lane, and non-premature `v1.6.0` posture | docs-only (no gate rerun required) |
...
7. Slice 3 (`docs(governance)`) aligned top-level truth surfaces: `README.md`, `docs/PROJECT_STATUS.md`, `docs/agent/MASTER_OVERVIEW.md`, and `docs/dev/WORKTREE_SETUP_NOTES.md`.
