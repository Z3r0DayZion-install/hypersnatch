...
Close remaining trust-layer and governance-layer debt after shipped `v1.5.5` before any `v1.6.0` expansion.

## In Scope

1. WARN-default and strict signoff interpretation tightening.
2. Deeper runtime interaction proof in `verify:ui`.
3. Top-level governance/status/setup alignment to shipped `v1.5.5` truth.
...
3. Top-level docs reflect shipped `v1.5.5` and active `v1.5.6` hardening lane.
