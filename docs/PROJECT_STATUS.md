...
Current hardening target: `1.5.4` (trust/proof/governance tightening before expansion)
...
- Post-`v1.5.3` reality audit merged (decision: complete `v1.5.4` hardening before any `v1.6.0` expansion)
- Active branch: `release-readiness/v1.5.4-hardening`
...
- `v1.5.3` shipped from clean merged-main proof and tagged (`v1.5.3`)
- v1.5.x maintenance lines continue to require clean-worktree proof before tagging

Current v1.5.4 hardening focus:
- WARN-profile interpretation tightening for stable signoff clarity
- deeper runtime UI proof execution beyond static hook presence checks
- top-level governance/status/setup narrative consistency with shipped `v1.5.3` truth
