...
[![Release](https://img.shields.io/badge/release-v1.6.17-brightgreen)](https://github.com/Z3r0DayZion-install/hypersnatch/releases/tag/v1.6.17)
...
**[HyperSnatch-Setup-1.6.17.exe](https://github.com/Z3r0DayZion-install/hypersnatch/releases/tag/v1.6.17)** — Windows installer

SHA256 hashes in [`SHA256SUMS.txt`](https://github.com/Z3r0DayZion-install/hypersnatch/releases/download/v1.6.17/SHA256SUMS.txt) and [`docs/release/RECEIPT_v1.6.17.md`](docs/release/RECEIPT_v1.6.17.md).
...
```powershell
Get-FileHash .\HyperSnatch-Setup-1.6.17.exe -Algorithm SHA256
```

Compare against [`SHA256SUMS.txt`](https://github.com/Z3r0DayZion-install/hypersnatch/releases/download/v1.6.17/SHA256SUMS.txt).
