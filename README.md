...
[![Release](https://img.shields.io/badge/release-v1.6.8-brightgreen)](https://github.com/Z3r0DayZion-install/hypersnatch/releases/tag/v1.6.8)
...
**[HyperSnatch-Setup-1.6.8.exe](https://github.com/Z3r0DayZion-install/hypersnatch/releases/tag/v1.6.8)** — Windows installer

SHA256 hashes in [`docs/release/RELEASE_PROOF_v1.6.8.md`](docs/release/RELEASE_PROOF_v1.6.8.md).
...
```powershell
Get-FileHash .\HyperSnatch-Setup-1.6.8.exe -Algorithm SHA256
```

Compare against [`docs/release/RELEASE_PROOF_v1.6.8.md`](docs/release/RELEASE_PROOF_v1.6.8.md).
...
| Version | Notes |
|---------|-------|
| v1.6.8 | Fresh-install window-show hotfix (show:false, executeJavaScript removal, did-fail-load handler) |
